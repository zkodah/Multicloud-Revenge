...
#   AND DATE(TIMESTAMP_TRUNC(usage_start_time, Day, 'US/Pacific')) IN ('2025-03-24')
...
WHERE
  cost_type != 'tax'
  AND cost_type != 'adjustment'
  #AND DATE(TIMESTAMP_TRUNC(usage_start_time, Day, 'US/Pacific')) IN ('2025-04-15')
  AND DATE(TIMESTAMP_TRUNC(usage_start_time, Day, 'US/Pacific')) BETWEEN '2025-04-15' AND '2025-04-19'
GROUP BY
  fecha,
  project.name,
  project.id,
